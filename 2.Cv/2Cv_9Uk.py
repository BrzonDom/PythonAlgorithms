...
.
    ...
    Algoritmus rozpůlí interval mezi body x1

a x2, tedy nalezne bod x′=x1+x22 a pokud je f(x′)<0 pak nahradí bod x1 bodem x′, jinak nahradí bod x2 bodem x′
.
Výše uvedený krok se opakuje dokud není |x1−x2|<ϵ
, kde ϵ
...
Na počátku zvolte x1=0
a x2=y pro kladná y>1, x1=y a x2=0 pro záporná y<−1, a x1=−1 a x2=1 v ostatních případech.
